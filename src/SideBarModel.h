...
{
public:
    SideBarItem( const QModelIndex&, const QList<SideBar::Type>& );
...
private:
    ...
    const QList<SideBar::Type>& m_masterList;
};
...
public:
    ...
    SideBar::Type typeAtIndex( const QModelIndex& i ) const;
    const Track trackAtIndex( const QModelIndex& i ) const;    
    const SideBarItem::Classification classificationAtIndex( const QModelIndex& i ) const;
...
private:
    ...
    QList<SideBar::Type> m_masterList;
